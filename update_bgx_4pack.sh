...
${COINDAEMONCLI} -/home/${COINl}2/.${COINl} stop
${COINDAEMONCLI} -/home/${COINl}3/.${COINl} stop
${COINDAEMONCLI} -/home/${COINl}4/.${COINl} stop
sleep 2
    rm ${COINDAEMON}
    rm ${COINDAEMONCLI}
...
echo -e ${BOLD}"Re-launching Third ${COIN3} Node"${CLEAR}
...
echo -e ${BOLD}"Re-launching Fourth ${COIN3} Node"${CLEAR}
