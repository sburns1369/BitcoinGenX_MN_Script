...
sleep 5
echo
echo -e "${GREEN}Configuring seventh BitcoinGenX Node${CLEAR}"
...
echo "rpcport=19027" >> /home/bitcoingenx7/bitcoingenx.conf
echo "listen=0" >> /home/bitcoingenx7/bitcoingenx.conf
echo "externalip=[${MNIP7}]:4488" >> /home/bitcoingenx7/bitcoingenx.conf
echo "masternodeprivkey=$privkey7" >> /home/bitcoingenx7/bitcoingenx.conf
if [[ $NULLREC = "y" ]] ; then
...
echo "scriptVersion7 : 0.9g" >> /usr/local/nullentrydev/bgx.log
fi
sleep 5
echo
echo -e "${GREEN}Configuring eigth BitcoinGenX Node${CLEAR}"
...
echo "rpcport=19028" >> /home/bitcoingenx8/bitcoingenx.conf
echo "listen=0" >> /home/bitcoingenx8/bitcoingenx.conf
echo "externalip=[${MNIP8}]:4488" >> /home/bitcoingenx8/bitcoingenx.conf
echo "masternodeprivkey=$privkey8" >> /home/bitcoingenx8/bitcoingenx.conf
if [[ $NULLREC = "y" ]] ; then
...
echo "scriptVersion8 : 0.9g" >> /usr/local/nullentrydev/bgx.log
fi
sleep 5
echo
