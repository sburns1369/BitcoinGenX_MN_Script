...
sudo touch /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "rpcuser=user"`shuf -i 100000-9999999 -n 1` >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "rpcpassword=pass"`shuf -i 100000-9999999 -n 1` >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "rpcallowip=127.0.0.1" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "server=1" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "daemon=1" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "maxconnections=250" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "masternode=1" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "rpcport=19021" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "listen=0" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "externalip=$(hostname -I | cut -f1 -d' '):4488" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "masternodeprivkey=$MNKEY" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "addnode=23.94.102.195:4488" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "addnode=0" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "addnode=0" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "addnode=0" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "addnode=0" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
echo "addnode=0" >> /home/bitcoingenx0/.bitcoingenx/bitcoingenx.conf
...
until bitcoingenx-cli -datadir=/home/bitcoingenx0/.bitcoingenx mnsync status | grep -m 1 'IsBlockchainSynced" : true'; do
bitcoingenx-cli -datadir=/home/bitcoingenx0/.bitcoingenx getblockcount
sleep 60
done
...
echo -e "${YELLOW} bitcoingenx-cli -datadir=/home/bitcoingenx0/.bitcoingenx masternode status"${CLEAR}
echo -e "${YELLOW}For mn1: \"bitcoingenx-cli -datadir=/home/bitcoingenx0/.bitcoingenx masternode status\""${CLEAR}
echo
